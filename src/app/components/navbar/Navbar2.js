...
const Navbar2 = () => {
  ...
  return (
    <nav className="bg-gray-400">
      <div className="max-w-8xl mx-auto flex items-center justify-between h-16 px-4 border-b border-solid border-slate-600">
        <div className="flex-shrink-0 font-bold tracking-wider text-2xl">
          CodingLab
        </div>
